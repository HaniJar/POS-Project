  ...
  : [
      {
        ...
        category: "Babies",
        price: 79.99,
        img: "https://i.postimg.cc/BbqhHJx1/baby-body-wash.jpg",
      },
      {
        title: "Nivea Body Spray",
        category: "Woman's",
        price: 40.95,
        img: "https://i.postimg.cc/rwnD5TrR/nivea-body-spray.jpg",
      },
      {
        title: "Baby Powder",
        category: "Baby Powder",
        price: 59.99,
        img: "https://i.postimg.cc/vZLpK8zD/baby-powder.jpg",
      },
      {
        title: "Mitchum Roll-on",
        category: "Woman's",
        price: 49.99,
        img: "https://i.postimg.cc/tC9d5XYB/mitchum-roll-on.jpg",
      },
      {
        title: "Baby Body Lotion",
        category: "Babies",
        price: 79.99,
        img: "https://i.postimg.cc/2SHtfTWK/baby-lotion.jpg",
      },
      {
        title: "Nivea Body Lotion",
        category: "Woman's",
        price: 59.99,
        img: "https://i.postimg.cc/FztqBRSF/nivea-lotion.jpg",
      },
    ];
    ...
    document.querySelector("#products").innerHTML += `
      ...
      <h2 class="card-title"> ${product.title}</h2>
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-dark w-50" data-bs-toggle="modal" data-bs-target="#editProduct${position}" >
          Edit
        </button>
        <button type="button" class="btn btn-primary w-50 ms-3" onclick="deleteProduct(${position})" >
          Delete
        </button>
          </div>
